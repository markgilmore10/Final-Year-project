...
class SalesController{
	...
	public static function ReOpenTableController(){
		 ...
		 if(isset($_POST["openTable"])){
            ...
            $getSale = ModelSales::ShowSalesModel($table1, $item, $value);
            ...
            if($productChange){
                ...
                $productsList_2 = json_decode($getSale["products"], true);
                ...
                foreach ($productsList_2 as $key => $value) {
                    ...
                    $value1a_2 = $getProduct_2["sales"] - $value["quantity"];
                    ...
                    $value1b_2 = $value["quantity"] + $getProduct_2["stock"];
                ...
                $value1a_2 = $getCustomer_2["purchases"] - array_sum($totalPurchasedProducts_2);
            	...
            	$answer = ModelTables::HoldSaleModel($table1, $table2, $data);
            ...
            if($productChange){
            // Update customer purchases, stock levels and product sale figures
            $productsList = json_decode($_POST["products"], true);
